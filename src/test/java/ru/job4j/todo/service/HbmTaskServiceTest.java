...
class HbmTaskServiceTest {
    ...
    public void whenUpdateThenTrue() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var task = taskRepository.save(new Task(1, "task1", creationDate, true, new User()));
        var updatedTask = new Task(1, "task1updated", creationDate, true, new User());
    ...
    public void whenIncorrectTaskUpdateThenFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var task = taskRepository.save(new Task(1, "task1", creationDate, true, new User()));
        var updatedTask = new Task(2, "task1updated", creationDate, true, new User());
    ...
    public void whenFindNewThenNewTaskList() {
        ...
        var task2 = new Task(2, "task2", creationDate, false, new User());
        var task3 = new Task(3, "task3", creationDate.minusDays(1), true, new User());
