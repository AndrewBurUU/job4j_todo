...
public class HbmRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var task = new Task(1, "task1", creationDate, false, new User());
    ...
    public void whenSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var task1 = hbmRepository.save(new Task(1, "task1", creationDate, false, new User()));
        var task2 = hbmRepository.save(new Task(2, "task2", creationDate, false, new User()));
        var task3 = hbmRepository.save(new Task(3, "task3", creationDate, false, new User()));
    ...
    public void whenDeleteThenGetEmptyOptional() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var task = hbmRepository.save(new Task(1, "task1", creationDate, false, new User()));
    ...
    public void whenUpdateThenGetUpdated() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var task = hbmRepository.save(new Task(1, "task1", creationDate, false, new User()));
        var updatedTask = new Task(task.getId(), "task1updated", creationDate.plusDays(1), true, new User());
    ...
    public void whenUpdateUnExistingTaskThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var task = hbmRepository.save(new Task(1, "task1", creationDate, false, new User()));
        var isUpdated = hbmRepository.update(new Task(2, "task2", creationDate, true, new User()));
